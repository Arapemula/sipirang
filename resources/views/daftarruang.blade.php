...
<div class="container-fluid py-4">
    <div class="row">
        ...
        <div class="col-md-2 d-flex flex-column align-items-end justify-content-center gap-2">
            ...
            @if ($currentPage > 1)
                <a href="{{ $rooms->url($currentPage - 1) }}" class="btn btn-outline-secondary p-2 fs-5" style="width: 50px;">↑</a>
            @else
            ...
            @for ($i = $start; $i <= $end; $i++)
                ...
                @else
                    <a href="{{ $rooms->url($i) }}" class="btn btn-outline-secondary p-2 fs-5" style="width: 50px;">{{ $i }}</a>
                @endif
            @endfor
